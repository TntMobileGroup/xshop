package com.tom.xshop.ui.thirdparty.SlidingUpPanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Flags indicating that sliding panel is being hidden
     */
    private boolean mIsPanelBeingHidden;
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.slidingpanel_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.slidingpanel_below_shadow);
            }
